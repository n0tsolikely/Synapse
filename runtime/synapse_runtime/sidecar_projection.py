...
def _apply_draftshot_projection(
    *,
    ...
    state["current_active_draftshot_truth_state_counts"] = dict(summary.get("current_active_draftshot_truth_state_counts") or {})
    ...
    manifold["current_active_draftshot_truth_state_counts"] = dict(summary.get("current_active_draftshot_truth_state_counts") or {})
...
def _apply_snapshot_candidate_projection(
    *,
    ...
    state["current_eod_candidate_truth_state_counts"] = dict(summary.get("current_eod_candidate_truth_state_counts") or {})
    state["current_control_sync_candidate_truth_state_counts"] = dict(summary.get("current_control_sync_candidate_truth_state_counts") or {})
    ...
    manifold["current_eod_candidate_truth_state_counts"] = dict(summary.get("current_eod_candidate_truth_state_counts") or {})
    manifold["current_control_sync_candidate_truth_state_counts"] = dict(summary.get("current_control_sync_candidate_truth_state_counts") or {})
