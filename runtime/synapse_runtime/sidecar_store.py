...
def _default_state(subject: str) -> dict[str, Any]:
    return {
        ...
        "truth_draft_count": 0,
        "current_truth_draft_paths": [],
        "guild_order_candidate_count": 0,
        "codex_candidate_count": 0,
        "build_manual_candidate_count": 0,
        "disclosure_candidate_count": 0,
        ...
        "compaction_manifest_count": 0,
        "eligible_cooling_manifest_count": 0,
        "blocked_cooling_manifest_count": 0,
        "hot_memory_counts": {},
        "warm_memory_counts": {},
...
def _default_manifold(subject: str) -> dict[str, Any]:
    return {
        ...
        "guild_order_candidate_details": [],
        "codex_candidate_details": [],
        "build_manual_candidate_details": [],
        "disclosure_candidate_details": [],
        ...
        "truth_draft_count": 0,
        "current_truth_draft_paths": [],
        "recent_truth_draft_details": [],
        "truth_draft_index_path": None,
        "packet_section_keys": [],
        "last_synthesis_refresh_at": None,
        "active_onboarding_id": None,
        "latest_confirmed_onboarding_id": None,
        ...
        "eligible_cooling_manifest_count": 0,
        "blocked_cooling_manifest_count": 0,
        "compaction_family_counts": {},
        "hot_memory_counts": {},
        "warm_memory_counts": {},
        "cold_memory_artifact_count": 0,
        "recent_compaction_manifest_details": [],
        "provenance_status": None,
        "provenance_last_observed_at": None,
        "provenance_last_watch_at": None,
        "provenance_blockers": [],
