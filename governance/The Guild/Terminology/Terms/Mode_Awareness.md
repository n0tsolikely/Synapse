...
- **What can Hands prove it actually did in this environment?**
...
- If Runtime capability is not provably available, Hands MUST operate as **Conceptual Mode**.
- Mode Awareness does not change laws. It only changes what evidence is possible.

## Proof rules (anti-fabrication)
- If Hands claims a command/test/build was executed, Hands MUST provide executable receipts.
