...
class ProvenanceTests(unittest.TestCase):
    ...
    def _write_accepted_quest(self, *, bundle_path: Path | None) -> Path:
        ...
        lines = [
            ...
            "",
            "Coherent Outcome: Validate wrapper proof provenance and keep trust blockers honest.",
            "",
            "Closure Statement: Close only when wrapper proof provenance is validated and any remaining blockers are captured in the completion audit.",
            "",
            "Split Triggers: Split if wrapper proof validation and trust-surface hardening become independently closable outcomes.",
            "",
            "",
            "Risk: R1",
            "",
            ...
            "",
            "Plan Artifact Refs: /tmp/provenance-plan.yaml",
            "",
